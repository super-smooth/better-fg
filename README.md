...
```bash
brew install super-smooth/tap/better-fg
```

### Using Install Script

```bash
curl -sSL https://raw.githubusercontent.com/super-smooth/better-fg/main/install.sh | bash
```
...
nix run github:super-smooth/better-fg
```

### Manual Installation

Download the latest binary from the [releases page](https://github.com/super-smooth/better-fg/releases) and place it in your `PATH`.
